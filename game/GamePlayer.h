...
#define IMG_PLAYER_RIGHT "src/playerRight.png"
#define IMG_PLAYER_LEFT "src/playerLeft.png"
#define IMG_PLAYER_UP "src/playerUp.png"
#define IMG_PLAYER_DOWN "src/playerDown.png"
